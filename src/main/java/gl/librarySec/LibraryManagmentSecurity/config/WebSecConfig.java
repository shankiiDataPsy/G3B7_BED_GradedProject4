...
public class WebSecConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/user/put/page/*", "/user/put/post/*", "/user", "/user/", "/user/get/*", "/api/employees/put/page/*", "/api/employees/put/post/*", "/api/employees", "/api/employees/", "/api/employees/get/*").hasAnyAuthority("USER", "ADMIN")
                .antMatchers("/user/add/page/", "/user/add/post/", "/user/del/page/*", "/api/employees/add/page/", "/api/employees/add/post/", "/api/employees/del/page/*").hasAuthority("ADMIN")
